    ...
    <div class="col-sm-4 mt-3 mt-md-0">
      <div class="row h-100">
        <div class="col-12 mb-3">
          {% include figure.liquid loading="eager" path="assets/img/hygene/molecule.png" class="img-fluid rounded z-depth-1 h-100" zoomable=true %}
        </div>
        <div class="col-12">
          {% include figure.liquid loading="eager" path="assets/img/hygene/mesh.png" class="img-fluid rounded z-depth-1 h-100" zoomable=true %}
        </div>
      </div>
    </div>
</div>
