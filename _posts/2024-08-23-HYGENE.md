...
<div class="row justify-content-center align-items-stretch">
  <!-- Left: Electronic Circuit -->
  <div class="col-sm-6 d-flex mt-3 mt-md-0">
    <div class="w-100 d-flex align-items-stretch">
      {% include figure.liquid loading="eager" path="assets/img/hygene/electronic_circuit.png" class="img-fluid rounded z-depth-1 w-100 h-100" zoomable=true %}
    </div>
  </div>

  <!-- Right: Stacked Molecule + Mesh -->
