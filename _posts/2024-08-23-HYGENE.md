...
<div class="row justify-content-sm-center">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/random_graph.png" class="img-fluid rounded z-depth-1" width="75%" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/random_hypergraph.png" class="img-fluid rounded z-depth-1" width="75%" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/mesh.png" class="img-fluid rounded z-depth-1" width="75%" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/molecule.png" class="img-fluid rounded z-depth-1" width="75%" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/electronic_circuit.png" class="img-fluid rounded z-depth-1" width="75%" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/clique_expansion.png" class="img-fluid rounded z-depth-1" width="85%" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/clique_coarsening.png" class="img-fluid rounded z-depth-1" width="85%" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3 justify-content-sm-center">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/bipartite_coarsening.png" class="img-fluid rounded z-depth-1" width="70%" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/hypergraph_generation.png" class="img-fluid rounded z-depth-1" width="80%" zoomable=true %}
    </div>
</div>
<div class="caption">
