...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/random_graph.png" class="img-fluid rounded z-depth-1" width="50%" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/random_hypergraph.png" class="img-fluid rounded z-depth-1" width="50%" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/clique_expansion.png" class="img-fluid rounded z-depth-1" width="50%" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hygene/clique_coarsening.png" class="img-fluid rounded z-depth-1" width="50%" zoomable=true %}
    </div>
</div>
<div class="caption">
