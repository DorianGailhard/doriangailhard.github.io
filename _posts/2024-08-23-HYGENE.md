...
toc:
  sidebar: true
---
Cited: {% cite bergmeister2024efficient ren2024flowarscalewiseautoregressiveimage loukas2018graph %} {% cite test %}
...
Our work builds upon the foundation laid by the paper **Efficient and Scalable Graph Generation through Iterative Local Expansion** {% cite test %}, which introduces an innovative method for graph generation. This approach draws inspiration from the tradition of graph coarsening algorithms.
