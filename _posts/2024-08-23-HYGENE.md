...
<div class="row justify-content-sm-center align-items-stretch">
    ...
    <div class="col-sm-6 mt-3 mt-md-0 d-flex">
        <div class="w-100">
            {% include figure.liquid loading="eager" path="assets/img/hygene/electronic_circuit.png" class="img-fluid rounded z-depth-1 h-100" zoomable=true %}
        </div>
    </div>
    ...
    <div class="col-sm-6 mt-3 mt-md-0 d-flex">
        <div class="d-flex flex-column w-100">
            <div class="flex-fill mb-3">
                {% include figure.liquid loading="eager" path="assets/img/hygene/molecule.png" class="img-fluid rounded z-depth-1 w-100 h-100" zoomable=true %}
            </div>
            <div class="flex-fill">
                {% include figure.liquid loading="eager" path="assets/img/hygene/mesh.png" class="img-fluid rounded z-depth-1 w-100 h-100" zoomable=true %}
            </div>
        </div>
    </div>
</div>
