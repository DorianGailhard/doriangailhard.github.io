...
This blog post will summarize our paper, **HYGENE: A Diffusion-based Hypergraph Generation Method** {% cite bergmeister2024efficient %}, accepted at **AAAI-25**. To the best of our knowledge, this work introduces the first deep-learning based method for hypergraph generation. Code is available [here](https://github.com/DorianGailhard/SODA_Hypergraph-generation).
